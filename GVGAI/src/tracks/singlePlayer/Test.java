...
public class Test {
    ...
    public static void main(String[] args) {
		...
		String sampleOLETSController = "tracks.singlePlayer.advanced.olets.Agent";
                ...
                // This is the planner controler
                String plannerControler = "Planner.Agent";
		...
		ArcadeMachine.runOneGame(game, level1, visuals, plannerControler, recordActionsFile, seed, 0);
