...
public class CompetitionParameters
{
     ...
     */
    public static final int ACTION_TIME = 500000;

    /**
     * Milliseconds for controller disqualification, if it returns an action after this time.
     */
    public static final int ACTION_TIME_DISQ = 510000;
     ...
     */
    public static final int MAX_TIMESTEPS = 1000000; //2000
    ...
    public static int LEARNING_BLOCK_SIZE = 30; // Tamaño de los bloques de la visualizacion
