...
class DQNetwork:
	...
	def __init__(self, name="DQNetwork", writer_name="DQNetwork", create_writer = True,
		...
		with tf.variable_scope(self.variable_scope):
			...
			# Max Pooling
			self.conv1 = tf.layers.max_pooling2d(inputs = self.conv1, pool_size = 2, strides = 2, padding = "VALID")
			...
			# Max Pooling
			self.conv2 = tf.layers.max_pooling2d(inputs = self.conv2, pool_size = 2, strides = 2, padding = "VALID")
			...
			# Max Pooling
			self.conv3 = tf.layers.max_pooling2d(inputs = self.conv3, pool_size = 2, strides = 2, padding = "VALID")
			...
			if l4_num_filt != -1:
				...
				# Max Pooling
				# self.conv4 = tf.layers.max_pooling2d(inputs = self.conv4, pool_size = 2, strides = 2, padding = "VALID")
